...
<body>
  ...
  <div class="two-col">
    <div>
      <div class="section">
        <div class="section-title">1. Income & Cashflow</div>
      ...
      <div class="section">
        <div class="section-title">2. Assets & Liabilities</div>
    ...
    <div>
      <div class="section">
        <div class="section-title">3. Behavioural Signals</div>
        <div class="grid-3" style="margin-bottom: 8px;">
          <div class="metric-box">
      ...
      <div class="section">
        <div class="section-title">4. Fraud & Identity Strength</div>
        <div class="grid-3" style="margin-bottom: 8px;">
          <div class="metric-box">
      ...
      <div class="section">
        <div class="section-title">5. Transactions & Utility</div>
  ...
  <div class="footer">
    Generated by Stori AI Alternative Data Credit Scoring System | Report ID: ${consumer.id}-${Date.now()} | This is a system-generated report.
  </div>
</body>
</html>
  `
